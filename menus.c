...
int menuTabelas()
{
    ...
    printf("___________________________________________________________________________\n");
    printf("\t1 - Ver tabela\n");
    printf("\t2 - Apagar tabela\n");
    printf("\t3 - Apagar todo o conteudo da tabela\n");
    printf("\t4 - Procurar valores na tabela\n");
    printf("\t5 - Apagar dados da tabela sob condição\n");
    printf("\t6 - Atualizar Valores\n");
    printf("\t7 - Inserir Dados a tabela\n");
    printf("\t8 - Inserir Campos a tabela\n");
